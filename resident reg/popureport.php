		...
		<tr>
			<td>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0">
					<tr>
						<td width="250" height="930" valign="top">
...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<div style="margin-left:70%; width:50px;  text-align:center;"> <a href="javascript:Clickheretoprint()"><img src="image/DPIC_36483.jpg" /></a></div>
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						...
						<div align="center" style="margin-top:10px;"><strong><img src="image/r.jpg" width="100%" height="80" align="center">
								<p align="center"><strong>Daily Population Registration Report on <?php echo date('Y-m-d'); ?> </strong></div>
						<?php
						$a = date('Y-m-d');
						$b = date('Y-m-d');
						$m = "Male";
						$f = "Female";
						$result1 = mysqli_query($conn,"SELECT * FROM population where DateOfRegistration BETWEEN '$a' AND '$b' and Sex='$m'");
						$con1 = mysqli_num_rows($result1);
						$result2 = mysqli_query($conn,"SELECT * FROM population where DateOfRegistration BETWEEN '$a' AND '$b' AND Sex='$f'");
						$con2 = mysqli_num_rows($result2);
						$total = $con1 + $con2;
						$result3 = mysqli_query($conn,"SELECT * FROM population where DateOfRegistration BETWEEN '$a' AND '$b'");
						$con = mysqli_num_rows($result3);
						if ($con < 1)
							echo " <font color='red'>You have no resident register in the date " . $a . " </font>";
						else {
						?>
							<table width="100%" border="0.5" align="center" cellpadding="0" cellspacing="0">
								<thead>
									<tr bgcolor="#cccccc" style="margin-bottom:10px;">
										...
										<th width="113">
											<div align="center">PlaceOfBirth</div>
										</th>
										<th width="130">
								...
								<tbody>
									...
									while ($row3 = mysqli_fetch_array($result3)) {
										echo '<tr>';
										$dasd = $row3['IdNumber'];
										$result4 = mysqli_query($conn,"SELECT * FROM population where IdNumber='$dasd'");


										while ($row4 = mysqli_fetch_array($result4)) {
										}
										echo '<td><div align="center">' . $row3['id'] . '</div></td>';
										echo '<td><div align="center">' . $row3['HouseNumber'] . '</div></td>';
										echo '<td><div align="center">' . $row3['FirstName'] . ' ' . $row3['middleName'] . '</div></td>';
										echo '<td><div align="center">' . $row3['Sex'] . '</div></td>';
										echo '<td><div align="center">' . $row3['Job'] . '</div></td>';
										echo '<td><div align="center">' . $row3['PlaceOfBirth'] . '</div></td>';
										echo '<td><div align="center">' . $row3['Nationality'] . '</div></td>';
			...
			<tr>
				<td colspan="7" bgcolor="#eee">General population registration report in today.</td>
			</tr>
			<tr>
				<td colspan="3">Female registered</td>
				<td colspan="1"><?php echo $con2; ?></td>
			</tr>
			<tr>
				<td colspan="3">Male registred</td>
				<td colspan="1"><?php echo $con1; ?></td>
			</tr>
			<tr>
				<td colspan="5">Total number of resident registered in today</td>
	...
	<div style="margin-left:80%; width:50px;  text-align:center;"><a href="populationreport.php"><img src="image/b.png" width="40" title="click here to back the search page"></a></div><br>
