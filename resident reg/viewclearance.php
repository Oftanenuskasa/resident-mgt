...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<table>
			<tr>
				<td>
					<div><b>View Clearance of resident to give or update</b></div>
					<hr />
					<form action="viewclearance.php" onsubmit='return formValidator()' method='POST'>
						<table>
							<tr>
					...
					if (isset($_POST['search'])) {
						$idno = $_POST['searchs'];
						$sql = "SELECT * FROM clearance WHERE IdNumber='{$idno}'";
...
<th>Delete</th>
							...
							while ($row = mysqli_fetch_array($result)) {
								...
								print("<td align = 'center' width = '1'><a href = 'detailclearance.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
         <td align = 'center' width = '1'><a href = 'edit_clearance.php?key1=" . $ctrl . "' onClick=\"return confirm('Are you shure Edit  id number $ctrl  data.')\"><img src = 'image/Edit.png' width='25px' height='25px' title='Edit' ></a></td>
		<td align = 'center' width = '1'><a href = 'deleteclearance.php?key1=" . $ctrl . "' onClick=\"return confirm('Are you shure Delete  id number $ctrl  data.')\"><img width='25px' height='25px' src = 'image/Delete.png' title='Delete'></img></a></td>
		");
								print("</tr>");
							}
							print("</table>");
