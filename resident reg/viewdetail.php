...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<table>
			<tr>
				<td>
					<div><b>Resident detail information</b></div>
					<hr />
					...
					if ($count == 1) {
						while ($row = mysqli_fetch_array($result)) {
							...
							$row11 = $row[11];
							$row12 = $row[12];
							$pimg = $row["UploadPicture"];
						}
					?>



						<table valign='top' align="center" style="width:470px; height:150px;border-radius:16px;border:2px solid #686868">
							<tr>
								<td></td>
								<td align="right" colspan="2"><a href="viewpop.php"><img src="image/Delete.png" title="Close"></a></td>
							</tr>
							<tr>
							<tr>
								<td rowspan="3"><img src="downlod/photo/<?php echo $pimg; ?> " width='130' height='100'></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b> registr Id:</b>
								</td>
								<td><?php echo $row0 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>House Number:</b>
								</td>
								<td><?php echo $row1 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>First Name:</b>
								</td>
								<td><?php echo $row2 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>middle Name:</b>
								</td>
								<td><?php echo $row3 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>Last Name:</b>
								</td>
								<td><?php echo $row4 ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>Place Of Birth:</b>
								</td>
								<td><?php echo $row9 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>Date Of Birth:</b>
								</td>
								<td><?php echo $row10 ?></td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>Date Of Registration:</b>
								</td>
