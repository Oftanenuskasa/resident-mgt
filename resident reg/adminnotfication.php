		...
		<tr>
			<td width="252" height='400'>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0" valign="top">
					<tr>
						<td width="270" height="620" valign="top">
...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		$num = mysqli_num_rows($result);
		if ($num > 0) {
			echo "<font color='white'><h4 style=\"width: 540;height: 40; background:brown;\"> Dear <font color=''>" . $ful . " </font>&nbspyou <font color=''>(" . $num . ")</font>&nbsp new request for deactivate an account.:</h3></font>";

			echo "<table id='vtable' style='width:100%;border:0px solid #eee;'  valign='top' align='center'><font color=white>
<tr>
<th width='10'bgcolor='#eee'><font color='blue' size='3'>User account </th>
<th bgcolor='#eee'><font color='blue' size='3'>  Content </th> 
<th bgcolor='#eee'><font color='blue' size='3'> From   </th>
</tr>";

			while ($row = mysqli_fetch_array($result)) {
				$sender = $row['from'];
				$user = $row['username'];
				$contente = $row['content'];

				echo "<tr>";
				print("<td align = 'left' width = '1' ><a href = 'activateuser.php?key1=" . $user . "'>$user</a></td>");

				print("<td align = 'left' width = '100%' >$contente</td>");
				print("<td align = 'left' width = '100%' >$sender</td>");
				echo ("</tr>");
			}
			echo ("</table>");
		} else {
			...
			echo "<h4 align='left' style=\"width: 540;height: 40; background:brown;\"><font color='white'><font color='grean' size='5'>(!)</font>  You have no new request for deactivate account.</font></h4>";
		}
		mysqli_close($conn);
		?>
	...
	<tr>
		<td colspan="3" height="25">
			<table border="0" align="left" width="92%" bgcolor="#CCCCCC" cellspacing="0">
				<tr>
					<td align="='center'">
						<font face="Times New Roman" color="black"><b> DURAME CITY RESIDENT RECORD MANAGEMENT SYSTEM &copy; 2024 COPY RIGHT RESERVED !!!</b>
						</font>
					</td>
				</tr>
			</table>
