...
<head>
	...
	<title>DC RRMS record officer</title>
</head>
...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<left>
			...
			<?php
			$result = mysqli_query($conn,"SELECT * FROM marrage_idcard where  content !=' for new registration' and status=0 ");
			$con = mysqli_num_rows($result);
			if ($con > 0) {
				echo "<h4 style='width:530px;height:50px;background:brown'><font color='white'><h4>Dear  " . $ful . "you have &nbsp;<font color=''>" . $con . "</font>&nbsp;new requset for register his/her wife/hasband.click the sender name to view detail of request. </h4></font>";
				echo "<table id='vtable' style='width:350px;border:0px solid #eee;' align='center' valign='top' align='left'><font color=white>";
				$i = 1;
				while ($row = mysqli_fetch_array($result)) {
					...
					echo "<tr>
<th bgcolor='#eee'><font color='blue' size='3'> <b> Requst $i send from:</b> </th>
</tr>";
					echo "<tr>";
					print("<td align = 'center' width = '1' color='red'><a href = 'viewregisterdetail.php?key1=" . $id . "'>$ctrl</a></td>");
				...
				echo "<h4 style='width:550px; height:50px;background:brown;'><font color='grean' size='5'>(!)</font><font color='white'>You have no new requset for register his/her wife/hasband and Id card preparation.</font> </h4>";
			}
			mysqli_close($conn);
			?>
			</td>
