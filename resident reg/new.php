...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		if ($c > 0) {
			echo "<h4 style='width:540px;height:50px;background:brown'><font color='white' size='3'> Dear<font color=''> " . $ful . "</font> you have (" . $c . ") new response for ID card preparation request.</font></h4>";

			echo "<table id='vtable' style='width:540px;border:1px solid #eee;' align='left' valign='top'><font color=white>
<tr>
<th bgcolor='white'><font color='blue' size='2'> From </th>
<th bgcolor='white'><font color='blue' size='2'>content          </th>
<th bgcolor='white'><font color='blue' size='2'>uplaod receipt         </th>
<th bgcolor='white'><font color='blue' size='2'>Delete          </th>
</tr>";

			while ($row = mysqli_fetch_array($result)) {
				$ctrl = $row['charmanname'];
				$ctrl2 = $row['content'];
				$id = $row['idnum'];
				echo "<tr>";
				echo "<td>";
				echo $row["charmanname"];
				echo "</td>";
				echo "<td>";
				echo $row["content"];
				echo "</td>";
				if ($id != 'none') {
					echo ("<td align = 'center' width = '1'><a href = 'update.php?key=" . $id . "'><img src = 'image/do.png' border = '0' width='30' title='uplaod';'></img></a></td>");
				} else
					echo "<td></td>";
				echo ("<td align = 'center' width = '1'><a href = 'del_replay1.php?key=" . $ctrl2 . "' onClick=\"return confirm('Are you shure to delete.')\"><img src = 'image/close.png' border = '0' title='Delete';'></img></a>
    </td>");
				echo ("</tr>");
			}
			echo ("</table>");
			...
			echo "<h4 style='width:540px;height:40px;background:brown' align='left'><font color='white'><font color='grean' size='6'>(!)</font> You have no new responce for the requset.</font></h4>";
		}
		?>
