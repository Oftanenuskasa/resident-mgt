...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		echo "<font color='white'> <h4 align='left'style=\"width: 540px;height: 50px;background:brown

;\"> This is <font color='white'>$id</font> requset detail.click approve to prepare id card</h3></font>";
		$result = mysqli_query($conn,"SELECT * FROM request  where id='$id1' and seen='0' ");


		echo "<table id='vtable' style='width:530px;border:1px solid #eee;' align='center' valign='top'><font color=white>
<tr>
...
<th bgcolor='#eee'><font color='black' size='2'>   Approve       </th>
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo $row["content"];
			echo "</td>";
			echo ("<td align = 'center' width = '1'><a href = \"display_residnet.php?House=" . $num . "&name=" . $id . "\" onClick=\"return confirm('Are you shure to prepare Id card.')\">approve</a>
    </td>");
			echo ("</tr>");
		}
		echo ("</table>");

		echo "<a href = 'viewrequest.php'><img src = 'image/b.png' width='40'border = '0' title='Back to view request page';'></img>";
		mysqli_close($conn);
		?>
		</td>
