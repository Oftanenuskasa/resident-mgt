...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		<fieldset>
			<legend align="center">
				<div class="legend"><b>Please Enter Your Comment the space provided below</b></div>
			</legend>
			<br>
			<div>
				<form onsubmit='return formValidator()' action='comment.php' method='POST'>
					<table align="center">


						<tr>
							<td>Comment :</td>
							<td><textarea name="comment" id="com" cols="30" rows="8" placeholder="Enter comment..." required=""></textarea></td>
						</tr>
						<tr>
							<td></td>
						</tr>
						<tr>
							<td></td>
							<td><input type='submit' value='Give' name='sub' onClick="return check(this.form);" />
		...
		if (isset($_POST['sub'])) {
			...
			$sql = "INSERT INTO comment (id,FirstName,Date,Comment)
VALUES
('none','$ful','$date','$_POST[comment]')";
			if (!mysqli_query($conn,$sql)) {
				die('Error: ' . mysqli_error($conn));
			} else {
				echo "<h4 style=\"width: 550px; height: 40px;background: brown;color: white\">Your comment successfully sent!! 10q for giving!!</h4>";
			}
		}
		mysqli_close($conn)
		?>
