...
";
		...
		<th width="1047" height="300" valign="top" bgcolor="white"><br>
			<div><b>View User</b></div>
			<hr />
			<fieldset>
				<legend align="center">
					<div class="legend"><b>View Your User Deteail</b></div>
				</legend>
				<br>
				<div>
					...
					?>
						<br>
						<table width="300" align="center" style="width:500px;background-color:#F5F5DC;height:280px;border-radius:10px;border:2px solid blue" valign='top'>
							<tr>

								<td width="100%" align="right"><a href="viewuser.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="image/close.PNG" title="back to view user page"></a></td>
							</tr>
							<tr>
								<th align="center">
									<font face="italic" color="blue" size="4"><u> <?php echo $row1 ?> Information detail</u></font>
								</th>
							</tr>
							<tr>
								<td align="center">
							...
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>id:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row0 ?></b>
								</td>
							</tr>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>First Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row1 ?></b>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Middle Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row2 ?></< /b>
									</font>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Last Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row3 ?></b>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row4 ?></b>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Username:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row5 ?></b>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row6 ?></b>
								</td>
							</tr>
							<tr>
								<td>
									<font face="times new roman" color="#336699" size="3"><b>Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row7 ?></b>
								</td>
							</tr>
						</table>
