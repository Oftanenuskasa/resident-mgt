	...
	<table border="0" width="92.8%" cellspacing="0">
		...
		<tr>
			<td id="dropdown" colspan="3">
				...
				<li><a href="comment.php"><img src="image/bel/gi.jpg" width="20" height="20"> <b>Give comment</b></a>
				</li>
				<li><a href="clerance_request.php"><b><img src="image/g.PNG" width="20" height="20">Clearance
							Request</b></a></li>
				...
				<li><a href="resi_changepass.php"><b><img src="image/ch.jpg" width="20" height="20">Change
							password</b></a></li>
				<li>
				</li>
...
";
									...
									?>
									<br>
									<font color="blue"><a href="resiprofile.php"><img
												src="image/activate.png"><?php echo $ful; ?>(change profile)</a></font>
						</td>
					</tr><br>
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		<form action='update.php' method='POST' enctype="multipart/form-data">
			<table valign='top' align="center"
				style="width:400px; margin-top:-110px; margin-top:-220px; height:150px;border-radius:16px;border:2px solid #686868">
				<tr>
					<td colspan="2" align="right"> <a href="new.php"><img src="image/close.png" width="30"
								title="Click here to back serach menu"></a></td>
				</tr>
				<tr>
					<td>Id number:</td>
		...
		if (isset($_POST['update'])) {
			...
			$updat = mysqli_query($conn,"update idcard set UploadPicture='$photo' where id_number='$id1'") or die(mysqli_error($conn));
			if ($updat) {
				echo "<h4 align='center'><font color='red'>....................................................................................................</h4></font>";
				echo "<h4 align='center'><font color='red'>Upload Sucessfully !!</h4></font>";
				echo "<h4 align='center'><font color='red'>.....................................................................................................</h4></font>";
			} else
				echo $id1;
		}
