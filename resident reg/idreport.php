...
gif" width="15%" height="150"><img src="image/get.
jpg" width="70%" height="150"><img src="pic/DSC06361.
...
";
		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/repo.jpg" width="100%" height="80" align="center"></strong><BR><strong>Idcard Preparation Report</strong></a>
							&nbsp;<strong>id prepared today</strong>&nbsp;&nbsp;&nbsp;</div>
						...
						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Farmer'";
						$result1 = mysqli_query($conn, $query);
						$fmale_far = mysqli_num_rows($result1);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Farmer'";
						$result2 = mysqli_query($conn, $query);
						$male_far = mysqli_num_rows($result2);
						$total_far = $fmale_far + $male_far;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Student'";
						$result3 = mysqli_query($conn, $query);
						$fmale_stu = mysqli_num_rows($result3);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Student'";
						$result4 = mysqli_query($conn, $query);
						$male_stu = mysqli_num_rows($result4);
						$total_stu = $fmale_stu + $male_stu;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Teacher'";
						$result5 = mysqli_query($conn, $query);
						$fmale_th = mysqli_num_rows($result5);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Teacher'";
						$result6 = mysqli_query($conn, $query);
						$male_th = mysqli_num_rows($result6);
						$total_th = $fmale_th + $male_th;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Doctor'";
						$result7 = mysqli_query($conn, $query);
						$fmale_doc = mysqli_num_rows($result7);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Doctor'";
						$result8 = mysqli_query($conn, $query);
						$male_doc = mysqli_num_rows($result8);
						$total_doc = $fmale_doc + $male_doc;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Guard'";
						$result9 = mysqli_query($conn, $query);
						$fmale_ga = mysqli_num_rows($result9);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Guard'";
						$result10 = mysqli_query($conn, $query);
						$male_ga = mysqli_num_rows($result10);
						$total_ga = $fmale_ga + $male_ga;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Phd'";
						$result11 = mysqli_query($conn, $query);
						$fmale_ph = mysqli_num_rows($result11);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Phd'";
						$result12 = mysqli_query($conn, $query);
						$male_ph = mysqli_num_rows($result12);
						$total_ph = $fmale_ph + $male_ph;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Master'";
						$result13 = mysqli_query($conn, $query);
						$fmale_ms = mysqli_num_rows($result13);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Master'";
						$result14 = mysqli_query($conn, $query);
						$male_ms = mysqli_num_rows($result14);
						$total_ms = $fmale_ms + $male_ms;

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Female' AND Job='Other'";
						$result15 = mysqli_query($conn, $query);
						$fmale_oth = mysqli_num_rows($result15);

						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b' AND Sex='Male' AND Job='Other'";
						...
						$query = "SELECT * FROM idcard WHERE DateOfTaken BETWEEN '$a' AND '$b'";
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="white">
								<thead>
									<tr bgcolor="#eee" style="margin-bottom:10px;">
										...
										<th width="136">
											<div align="center">Frist Name</div>
										</th>
										<th width="114">
			...
			<tr>
				<td colspan="7" align="center" bgcolor="#eee">
					<font color='black'>General Idcard report prepared in one day.</font>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4">The total number of Id card prepare In one day:</td>
	...
	<?php
							...
							echo "<font color='red'>No Idcard prepared in this date.</font>";
						}
	?>
	</td>
	</tr>
