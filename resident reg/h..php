	...
	<table border="0" width="92.8%" cellspacing="0">
		...
		<tr>
			<td id="dropdown" colspan="3">
				...
				<li>
					<b>login as&nbsp;
						<font color='blue'><?php echo "$_username"; ?></font>
					</b>
				</li>
			...
			<th width="1047" height="436" valign="top" bgcolor="white"><br>
				...
				?>
					...
					<div id="print_content">
						<table valign='top' align="center" style="width:420px; height:150px;border:2px solid #686868">
							<tr>
								<td><img src="image/lo.jpg" width="420" height="50" align="center"></td>
							</tr>
							<tr>
								<td align="center">
									<table valign='top' align="center" style="width:400px; height:150px;border-radius:16px;border:2px solid #686868">
										<tr>
											...
											<td><?php echo "<img src= '" . $row14 . "'width='100' height='70'>" ?></td>
										</tr>
										<tr>
										...
										<tr>
											<td>
												<font face="times new roman" color="#000000" size="3"><b>start or end:</b>
											</td>
											<td><?php echo $row13 . $pimg; ?></td>
										</tr>
