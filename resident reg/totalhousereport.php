...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
				...
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/ho.jpg" width="100%" height="80" align="center">
								<p align='center'><strong>The number of house in the kebele .
									</strong></div>
						</p>
						...
						$ner = "Kebele House";
						$m = '01';
						$idsql = "SELECT* FROM idcard";
						$idre = @$db->query($idsql);
						$id_results = $idre->num_rows;

						$mnerquery = "SELECT* FROM house where House_Type='" . $ner . "' AND Kebele='" . $m . "'";
						$mnerres = @$db->query($mnerquery);
						$mnernum_results = $mnerres->num_rows;
						$mdipquery = "SELECT* FROM house where House_Type='" . $dip . "' AND Kebele='" . $m . "'";
	  ...
	  <th >Total</th>
	   ...
	   <tr align="center">
	  <td bgcolor="#FFFFFF">private</td>
	  <td >' . ($dipt) . '</td>
	  </tr><tr align="center">
	  <td bgcolor="#FFFFFF">kebele house</td>
	  <td >' . ($nert) . '</td>
	  </tr>
	  </tr>
	  ...
	  <tr align="center">
		  <td colspan="" align="center" bgcolor="#FFFFFF">Total number of house in the kebele:</td><td>
  <b>' . ($dipt + $nert) . '</b></td>
	  </tr>
