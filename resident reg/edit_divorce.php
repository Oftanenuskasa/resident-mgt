					...
					<tr>
						...
						<td width="900" height="600" valign="top" bgcolor="cyan"><br><br>
							<table>
								<tr>
									<td>
										...
										<form action="give_divorce.php" onsubmit='return formValidator()' method='POST'>
											<table>
												<tr>
													<td class="search">Enter Divorce Idnumber:</td>
										...
										?>
											<form action='edit_divorce.php' method='POST'>
												<table valign='top' align="center" style="width:250px; margin-top:-110px; margin-top:-220px; height:150px;border-radius:20px;border:2px solid #686868">
													<tr>
														<td>drid:</td>
														<td><input type='text' name='ddrid' readonly value="<?php echo $row0 ?>"></td>
													</tr><br />
													<tr>
														<td>mrid:</td>
								...
								<tr>
									<td>register:</td>
									<td><input type='text' name='register' value="<?php echo $row8 ?>">
								</tr>
						</td><br />
					<tr>
...
if (isset($_POST['update'])) {
	$id = $_POST['ddrid'];
	$rid = $_POST['mrid'];
	$reason = $_POST['reasonofdivorce'];
	$noc = $_POST['nameofcourt'];
	$child = $_POST['numberofchildren'];
	$rn = $_POST['registrarname'];
	$place = $_POST['placeofdivorce'];
	$date = $_POST['date'];
	$register = $_POST['register'];
	$update = mysqli_query($conn, "update divorce set ddrid='$id',mrid='$rid',reasonofdivorce='$reason',nameofcourt='$noc',numberofchildren='$child',registrarname='$rn',placeofdivorce='$place',date='$date',register='$register'where ddrid='{$id}'") or die(mysqli_error($conn));
