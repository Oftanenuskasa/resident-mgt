...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		?>
		<font color='white'>
			<h3 align="center" style="width: 540px;height: 50px; background: brown;"> Welcome <font color=''><?php echo $ful ?>:</font>
				</h4>
		</font>
		<font color='black'>
			<h4 align="left"> Dear <font color='blue'><?php echo $ful ?></font> click the following link to see different request.</h4>
		</font>
		<h4 align="left"><img src="image/mail.PNG" width="30" height="25">
			<font color="red" size='5'><?php echo $coun; ?></font> request for clearance preparation &nbsp; <a href="viewclerance_request.php"><strong>View </strong></a>
		</h4>
		<h4 align="left"><img src="image/mail.PNG" width="30" height="25">
			<font color="red" size='5'><?php echo $cou; ?></font> request for renew/miss Id card &nbsp;<a href="viewrenew_request.php"><strong>View </strong></a>
		</h4>
		<h4 align="left"><img src="image/mail.PNG" width="30" height="25">
			<font color="red" size='5'><?php echo $count; ?></font> request for Id card preparation &nbsp;<a href="viewrequest.php"><strong>View </strong></a>
		</h4>
