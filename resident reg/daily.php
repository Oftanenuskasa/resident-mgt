...
";
		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/repo1.jpg" width="100%" height="80" align="center"></strong><BR><strong> Dailly Clearance Preparation Report</strong></a>
							on the day:&nbsp;<strong><?php echo date('Y-m-d'); ?></div>
			...
			<tr>
				<td colspan="7" align="center" bgcolor="#eee">
					<font color='black'>Genral clerance report in the date.</font>
				</td>
			</tr>
	...
	<?php
							...
							echo "<h4 style='width:540px;height:30px;background:;'><font color='black'>No clearance prepared between this date.</font></h4>";
						}
	?>
