...
";
					...
					<tr><?php
						...
						?>
						<td id="topnav">
							<li><a href="charmancomm.php"><strong>View comment<font color="red" size="3">(<?php echo $no; ?>)</font></strong> </a></li>
						</td>
					</tr>
					<tr>
						<td id="topnav">
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<?php
		$result = mysqli_query($conn,"SELECT * FROM request where seen='0'");
		$count = mysqli_num_rows($result);
		$result1 = mysqli_query($conn,"SELECT * FROM clearance_requset where seen=0");
		$coun = mysqli_num_rows($result1);
		$result2 = mysqli_query($conn,"SELECT * FROM requestr where seen='0'");
		$cou = mysqli_num_rows($result2);
		?>
		<font color='white'>
			<h4 align="left" style="width: 540px;height: 50px; background: red">
				<font color='grean' size='5'>(?)</font> Well come <font color='blue'><?php echo $ful ?></font> click the follwing link to see differnt requset.
			</h4>
		</font>

		<h4 align="left"> Clearance preparation requset you have(<font color="blue"><?php echo $coun; ?></font>) &nbsp;<a href="viewclerance_request.php"><strong>View </strong></a></h4>
		<h4 align="left"> Rnew/missing Id card requset you have(<font color="blue"><?php echo $cou; ?></font>) &nbsp;<a href="viewrenew_request.php"><strong>View </strong></a></h4>
		<h4 align="left">Id card preparation requset you have(<font color="blue"><?php echo $count; ?></font>) &nbsp;<a href="viewrequest.php"><strong>View </strong></a></h4>
