...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		?>
		<form action='resiprofile.php' method='POST' enctype="multipart/form-data">
			<table valign='top' align="center" style="width:450px; margin-top:-110px; margin-top:-220px; height:150px;border-radius:16px;border:0px solid #686868">
				<tr>
				...
				<tr>
					<td>Work in the kebele .</td>
				</tr>
				<tr>
					<td colspan="2" align="center"><img src="downlod/photo/<?php echo $pro; ?> " width='150' height='100'></td>
				</tr>
		...
		if (isset($_POST['update'])) {
			...
			if ($updat) {
				...
				echo "<h4 align='center' style='width:500px;height:30px;background:red;'><font color='grean'> Your photo Upload succesfuly. !!</h4></font>";
				$q = "select * from user where Username='$_username'";
				$re = mysqli_query($conn,$q);
				while ($r = mysqli_fetch_array($re)) {
					$pro = $r['profile'];
				...
				echo "<img src=\"downlod/photo/$pro \" width='100' height='80'>";
			} else
				echo $id1;
		}
