			...
			<td>
				<table border="0" bgcolor="#F0F8FF" cellspacing="0" id="mele">
					<tr>
						...
						<td width="100%" height="380" valign="top" bgcolor="WHITE">
							<center>
								<img src="image/bel/help2.png" width="300" height="120" /><br>
							</center>
							<font size="4" < font color="blue">Dear new applicant if you
								want to register as resident<br>
								<font size="3"></font>
								<font color='black'>
									1. you can contact record officer physically or<br>
									2. send request for record officer by sending your clearance<br>
									3. if your clearance is legal R.Officer approve as resident<br>
									4. the administrator creates your account<br>
									5. username as firstname.middlename, password as kebele.<br>
									6. then you can check by clicking notification and you can acces <br>
									7. for all residents to access this page<br>
									8. display home page<br>
									9. select your role<br>
									10. then fill your correct password and user name<br>
									11. click login
									12. if it is repeatedly incorrect <br>
									Click on forget and fill correct user name</p>
									13. again if it is incorrect contact to administrator and correct it<br>
								</font>
					...
					if (isset($_POST['submitMain'])) {
						...
						if (mysqli_num_rows($result_set) > 0) {
							if ($stat == 1) {
								...
								print "<img src='image/info.png' align='center' width='35px' height='25px'><I><font face='arial' color='red' size='3'> Your Account is Deactivated Please Contact the Administrator !!</font></I>";
							}
						} else {
