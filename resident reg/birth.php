						...
						<div>
							<form onsubmit='return formValidation()' action='birth.php' method='POST'>
								<table width="500" cellpadding="4">
									...
									<tr>
										<td>
											<font color="red"></font>Father full name:
										</td>
										<td><input type="text" size="20px" id='ffname' name='ffname' placeholder="Enter fulname..." style="width: 200;height: 30;background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
									</tr>
									<tr>
										<td>
											<font color="red"></font>Mother full name :
										</td>
										<td><input type="text" size="20px" id='mfname' name='mfname' pattern="\D{3,32}" placeholder="Enter fulname..." style="width: 200;height: 30;background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
									</tr>
									<tr>
										<td>
											<font color="red"></font>First name :
										</td>
										<td><input type="text" size="20px" id='fname' name='fname' pattern="\D{3,12}" placeholder="Enter firstname..." style="width: 200;height: 30;background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
									</tr>
									<tr>
										<td>
											<font color="red"></font>Middle name :
										</td>
										<td><input type="text" size="20px" id='mname' name='mname' pattern="\D{3,12}" placeholder="Enter middlname..." style="width: 200;height: 30;background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
									</tr>
									<tr>
										<td>
											<font color="red"></font>Last name :
										</td>
										<td><input type="text" size="20px" id='lname' name='lname' pattern="\D{3,12}" placeholder="Enter lastname..." style="width: 200;height: 30;background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" size="20px" id='age' name='age' pattern="\d{1,3}" placeholder="Enter Age..." style="width: 200;height: 30;background:#eee;" pattern="[0-9/ ]+" required title="Enter only number" maxlength="2"></td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										...
										<td>
											<input type="text" name="place" id="place" style="width: 200;height: 30;background:#eee;">
										</td>
									</tr>
									<tr>
										<td>
										...
										<td><input type="date" size="15px" id='date' name='date' class="mine_text_field_7" required style="width: 200;height: 30;background:#eee;" />
									...
									<tr>
										<td></td>
										<td><input type='submit' value='Register' name='birth' onClick="return check(this.form);" />
...
VALUES ('$_POST[id]','$_POST[ffname]','$_POST[mfname]','$_POST[fname]','$_POST[mname]','$_POST[lname]','$_POST[age]','$_POST[gender]','$_POST[place]','$_POST[date]','$dat')";
	...
	<td width="50" height="100" valign="top">
		...
		<table border="0" bgcolor="white" width="257" height="436" cellspacing="0" cellpadding="5">
			...
			<tr>
				<td align="left"> The vision of durame city that,to </td>
			</tr>
			<tr>
