...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		if ($con > 0) {
			echo " <h3 align='center' style='width:550px;height:30px;background:brown;'><font color='white'>You have  " . $con . " new news posted from chairman.</font></h3> ";
			while ($rel = mysqli_fetch_array($result)) {
				//$temp=$rel[4];
				echo "<h3 align='center' style='background:#606060;color:#FFDEAD;'>announcement news:</h1><br/>";
				echo "<font style='font-family:verdana,arial,helvetica,sans-serif;font-size:12px;line-height:18px;left-align:justify;padding-left:20px; margin-top:2px;'>" . $rel[1] . "</font></br>";
				...
				echo "<font style='font-family:verdana,arial,helvetica,sans-serif;font-size:12px;line-height:18px;left-align:justify;padding-left:20px; margin-top:2px;'> News posted  day:" . $rel[3] . "</font></br>";
				//echo '$_SESSION['price']';
				echo "</fieldset>";
			}
		} else
			echo "<h4 style='width:530px;height:30px;background:brown;' align='left'><font color='grean' size='5'>(!)</font><font color='white'>You have no new news posted from charman.</font></h4> ";
