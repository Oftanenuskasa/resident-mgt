...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		$con1 = mysqli_num_rows($result);


		?>
		<h3 align="center" style="width: 550px;height: 40px; background: brown;">
			<font color='blue'>
				<font color='white'>Welcome <?php echo $ful ?></font>:
		</h3>

		<h4 align='left'><img src="image/bel/m.PNG" width="30" height="25"><b>
				<font color='red' size="4">(<?php echo $con; ?>)</font> request for approve his/her hasband/wife registration and Id card preparation&nbsp;<a href="approve_register.php">
					<font color="grean">View </font>
				</a>
			</b></h4>
		<h4 align="left"><b><img src="image/mail.PNG" width="30" height="25">
				<font color='red' size="4">(<?php echo $coun; ?>)</font>request for approve new register &nbsp; <a href="register_requset.php">
					<font color="grean">View </font>
			</b></a></h4>
		<h4 align="left"><b>
				<font color='blue'><img src="image/ne.jpg" width="30" height="25">
					<font color='red' size="4">(<?php echo $con1; ?>)</font>new News posted from Chairman
				</font>&nbsp; <a href="view_newsrecord.php">
					<font color="grean">View </font>
				</a></h4>
		</font>
		<br>
