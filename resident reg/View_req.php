					...
					<tr>
						<td width="50" height="600" valign="top">
							<table border="0" width="100" cellspacing="0">
								...
								<tr>
									<td id="topnav">
										<li><a href="sendreq.php"><b>Send Responce to user</b></a></li>
									</td>
								</tr>
							</table>
						</td>
						<td width="900" height="600" valign="top" bgcolor="cyan"><br><br>
							...
							$result = mysqli_query($conn,"select * from sendreq");

							echo "<br>";
							echo "<table border=8 >";

							echo "<tr><th>Fulname</th><th>Kebele_ID</th><th>Kebele</th><th>purpose</th><th>Date</th><th colspan=2 width=10%>Action</th></tr>";

							while ($row = mysqli_fetch_array($result)) {
								$ctr3 = $row['purpose'];
								echo "<tr><td width=20%> $row[0] </td><td width=5%> $row[1] </td><td width=5%> $row[2] </td><td width=25%> $row[3] </td><td width=15%> $row[4] </td>" .

									"<td width=4% align = 'center' > <a href='Delete_req.php?key3=" . $ctr3 . "'>
