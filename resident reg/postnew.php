...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<fieldset>
			...
			<br>
			<div>
				<form onsubmit='return formValidat()' action='postnew.php' method='POST'>
					<table width="100%">
						<tr>
							<td width="147"><strong>News id :</strong></td>
							<td width="116"><input type="text" size="20px" name="new" id="new" placeholder="Enter id..." style="width: 200;height: 30; background:#eee;" pattern="[0-9 ]+" required title="Enter only number"></td>
						</tr>
						<tr>
							<td width="147"><strong>Subject :</strong></td>
							<td width="116"><input type="text" size="20px" name="subject" id="subject" placeholder="Enter subject..." style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alephabt"></td>
						</tr>
						<tr>
							<td><strong>News Content :</strong></td>

							<td><textarea name="content" id="content" cols="30" rows="6" pattern="\D{4,50}" placeholder="Enter purpose..." style="width: 200;height: 70; background:#eee;"></textarea></td>
						</tr>
						<tr>
							<td></td>
						</tr>
						<tr>
							<td height="53"></td>
							<td><input type='submit' value='Post' name='sub' onClick="return check(this.form);" style="width: 100;height: 30; background:#eee;" />
...
VALUES
('$_POST[new]','$_POST[subject]','$_POST[content]','$dat')";
			if (!mysqli_query($conn,$sql)) {
				die('Error: ' . mysqli_error($conn));
			} else {
				echo "<h4 style='width:530px;height:30px;background:brown'><font color='white'>News Posted Succesfully</font></h4>";
			}
		}
		mysqli_close($conn)
		?>
