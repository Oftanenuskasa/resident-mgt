		...
		<tr>
			<td>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0">
					<tr>
						<td width="250" height="830" valign="top">
...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<table>
			<tr>
				<td>
					<div><b>Edit Resident detail information</b></div>
					<hr />
					<?php
					$ctrl = $_REQUEST['key1'];
					...
					?>
						...
						<form action='edit_population.php' method='POST'>
							<table valign='top' align="center" style="width:500px; margin-top:-220px; height:150px; border-radius:16px;border:2px solid #686868" cellpadding="3">
								<tr>
									<td></td>
									<td align="right"><a href="viewpop.php"><img src="image/Delete.png" title="Close"></a></td>
								</tr>
								<tr>
									<td colspan="2" align="center"><img src="downlod/photo/<?php echo $row13; ?> " width='130' height='100'></td>
								</tr>
								<tr>
									<td>Id:</td>
								...
								<tr>
									<td>First Name:</td>
									<td><input type='text' name='firstname' value="<?php echo $row2 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
								</tr><br />
								<tr>
									<td>middle Name:</td>
									<td><input type='text' name='middlename' required="" value="<?php echo $row3 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
								</tr><br />
								<tr>
									<td>Last Name:</td>
									<td><input type='text' name='lastname' required="" value="<?php echo $row4 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet"></td>
								</tr><br />
								<?php $dob = new DateTime($row10);
								$age = $dob->diff(new DateTime);
								$ag = $age->y; ?>
								<tr>
									<td>age:</td>
									<td><input type='text' name='age' required="" value="<?php echo $ag; ?>" style="width: 200;height: 30; background:#eee;" pattern="[0-9 ]+" required title="Enter only number" readonly>
								</tr>
				</td><br />
			<tr>
				<td>Sex:</td>
				<td><input type='text' name='sex' required="" value="<?php echo $row6 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet">
			</tr>
			</td><br />
			<tr>
				<td>Kebele:</td>
				<td><input type='text' name='kebele' required="" value="<?php echo $row7 ?>" style="width: 200;height: 30; background:#eee;">
			</tr>
			</td><br />
			<tr>
				<td>Job:</td>
				<td><input type='text' name='job' value="<?php echo $row8 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet">
			</tr>
			</td><br />
			<tr>
				<td>Place Of Birth:</td>
				<td><input type='text' name='place' required="" value="<?php echo $row9 ?>" style="width: 200;height: 30; background:#eee;">
			</tr>
			</td><br />
			<tr>
				<td>Date Of Birth:</td>
				<td><input type='text' name='date' required="" value="<?php echo $row10 ?>" style="width: 200;height: 30; background:#eee;" pattern="[0-9- ]+" required title="Enter only number in date format(-)">
			</tr>
			</td><br />
			<tr>
				<td>Nationality:</td>
				<td><input type='text' name='nationality' required="" value="<?php echo $row12 ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alphabet">
			</tr>
			</td><br />
			<tr>
				<td align="center" colspan="2"><input type='submit' name='update' value='update' style="width: 100;height: 30; background:green;">
			</tr>
			</td>
		</table>
		</form>
	...
	if (isset($_POST['update'])) {
		...
		if (!empty($photo)) {
			$update = mysqli_query($conn, "update population set HouseNumber='$house',FirstName='$firstname',middleName='$middlename',LastName='$lastname',age='{$age}',Sex='$sex',Kebele='$kebele',Job='$job',PlaceOfBirth='$place',DateOfBirth='$date',DateOfRegistration='$dat',Nationality='$nationality',UploadPicture='" . $photo . "' where id='{$id}'") or die(mysqli_error($conn));
			echo "<h4 align='center' style='width:500px;height:30px;background:green'><font color=red>Update Sucessfully</h4></font>";
		} else {
			$update = mysqli_query($conn, "update population set HouseNumber='$house',FirstName='$firstname',middleName='$middlename',LastName='$lastname',age='{$age}',Sex='$sex',Kebele='$kebele',Job='$job',PlaceOfBirth='$place',DateOfBirth='$date',DateOfRegistration='$dat',Nationality='$nationality' where id='{$id}'")  or die(mysqli_error($conn));

			echo "<h4 align='center' style='width:500px;height:30px;background:brown'><font color=white>Update Sucessfully</h4></font>";
		}
	}
