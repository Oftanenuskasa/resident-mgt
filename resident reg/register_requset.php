...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		if ($coun > 0) {
			echo "<font color='white'><h4 style='width:550px; background:brown;height:40px;' >Dear &nbsp;<font color=''>" . $ful . "</font> you have &nbsp;<font color=''>(" . $coun . ") </font>new register request.click sender name to see their detail.</h4></font>";
...
";
			...
			while ($row = mysqli_fetch_array($result)) {
				...
				$id = $row['id'];
				echo " <tr>
<th bgcolor='#eee'><font color='blue' size='3'> <b> Request  $i send from: </b></th>
</tr>";
				echo "<tr>";
				print("<td align = 'center' width = '1' color='red'><a href = 'registerdetail.php?key1=" . $id . "&name=" . $ctrl . "'>$ctrl</a></td>");
			...
			echo "<h4 style='width:550px; background:brown;height:40px;' align='left'><font color='white' align='left'><font color='grean' size='6'>(!) </font>You have no new request for registration.</font> </h4>";
		}
		mysqli_close($conn);
		?>
		</td>
