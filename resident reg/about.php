		...
		<tr>
			<td>
				<table border="0" bgcolor="#F0F8FF" cellspacing="0" id="mele">
					<tr>
						<td width=252 height="430" valign="top">
						...
						<td width="100%" height="380" valign="top" bgcolor="WHITE">
							<div style="font-family: 'Times New Roman', Times, serif; font-size: 25px;">
								<h3 style="text-align: center;"><b>Mission</b></h3>
								<p>
									The mission is to create a civil service that serves
									the people, achieves the goals, policies, and strategies
									of the democratic government with full potential.
								</p>
								<h3 style="text-align: center;"><b>Vision</b></h3>
								<p>
									To build a fully potentiated citizenry and a<br>
									great human resource capable of achieving<br>
									the stated mission in Durame City.
								</p>
							</div>
						</td>

						<td width="100%" height="380" valign="top">
							<table border="0" bgcolor="white" width="257" height="500" cellspacing="0" cellpadding="5">
