...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		$result = mysqli_query($conn,"SELECT * FROM requestr where seen='0'");
		$count = mysqli_num_rows($result);
		if ($count > 0) {
			echo "<h4 align='left' style=\"width: 540px;height: 45px;background:#32CD32

;\"><font color='red'> <h4 align='center'>Dear  " . $ful . " you have <font color='blue'>" . $count . "</font> new requset for renew or missing Id.click sender name to see thir detail.</h4></font>";
			echo "<br>";
			echo "<table  style='width:350px;border:0px solid #eee;' align='center' valign='top' align='left'><font color=white>";
			$i = 1;
			while ($row = mysqli_fetch_array($result)) {
				$ctrl = $row['sendername'];
				echo "<tr>
<th bgcolor='#eee'><font color='Black' size='3'> <b> Requst " . $i . " send from:</b></font> </th>
</tr>";

				echo "<tr>";
				print("<td align = 'center' width = '1' color='red'><a href = 'renew_requestdtail.php?key1=" . $ctrl . "' title='Click here to see the dtail'>$ctrl</a></td>");
			...
			echo "<h4 align='center' style=\"width: 540px;height: 40px;background:#32CD32

;\"><font color='red'>No new request for renew or prepatre missing Id &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color='black' size='4'> x</font></h4></font>";
		mysqli_close($conn);
		?>
