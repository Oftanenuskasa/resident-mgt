...
<head>
 ...
 document.parent.src = "image/dj.jpg";
	...
	<title>durame city record managemnet system</title>
</head>
...
<body onload="parent.member()" onload="noBack();" onpageshow="if(event.persisted) noBack(); ">
		...
		<tr>
			<td>
				<table border="0" bgcolor="#F0F8FF" cellspacing="0" id="mele">
					<tr>
						<td width=252 height="400" valign="top">
						...
						<td width="100%" height="380" valign="top" bgcolor="WHITE">
							<center>
								<p><b>
										<font size="4"> Dear users: by using this information <br> you can contact us</font>
									</b></p>
								<img src="image/m4.jpg" width="200" height="50" /><br>
							</center>
							<center>
								<pre><font size="4">
	Sector: Durame City
	...
	Address: southeastern Ethiopia
  </font></pre>
							</center>
						</td>
						<td width="100%" height="360" valign="top">
							<table border="0" bgcolor="white" width="257" height="540" cellspacing="0" cellpadding="5">
