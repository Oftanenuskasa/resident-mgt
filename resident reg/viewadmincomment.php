		...
		<tr>
			<td width="252" height='300'>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0" valign="top">
					<tr>
						<td width="270" height="580" valign="top">
...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		$num = mysqli_num_rows($result);
		if ($num > 0) {
			echo "<font color='white'><h4 style='width:530px;height:40px;background:brown'> Dear:" . $ful . " &nbsp;you have&nbsp" . $num . "&nbsp new comment:</h3></font>";
			...
			while ($row = mysqli_fetch_array($result)) {
				$ctr2 = $row['Comment'];
				echo "<tr bgcolor='#eee'><td colspan='4' align='center'> <b><font color='red'>Comment $i.</b></font></td></tr>";

				echo "<tr><th>From</th><th>Comment</th><th>Date</th><th colspan=3 width=10%>Action</th></tr>";

				echo "<tr><td width=5% align='center'> $row[1] </td><td width=15% align='center'> $row[3] </td><td width=15% align='right'> $row[2] </td>" .

					"<td width=4% align = 'center' > <a href='deletecoment.php?key2=" . $ctr2 . "' onClick=\"return confirm('Are you shure to Delete.')\">
	 <img src='image/Delete.png'  alt='delete'></a></td></tr>";
				$i = $i + 1;
			}
			echo "</table>";
		} else {
			echo "<h4 align='left' style='width:530px;height:40px;background:brown'><font Color='white'><font color='grean' size='6'>(!) </font>You have no new comment given from user.</font></h3>";
		}
		?>
	...
	<tr>
		<td colspan="3" height="25">
			<table border="0" align="lefet" width="92%" bgcolor="#CCCCCC" cellspacing="0">
				<tr>
					<td align="='center'">
