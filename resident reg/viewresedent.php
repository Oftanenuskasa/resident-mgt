...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<table>
			<tr>
				<td>
					<div><b> Welcome &nbsp;<font color='blue'><?php echo $ful; ?></font>&nbsp;please enter house number to view resident information</b></div>
					<hr />
					<form action="viewresedent.php" onsubmit='return formValidator()' method='POST'>
						<table>
							<tr>
					...
					if (isset($_POST['search'])) {
						$house = $_POST['searchs'];
						$sql = "SELECT * FROM population WHERE HouseNumber='{$house}'";
...
<tr>
<th width='150px'>house number.</th>
<th>Names</th>
<th>View</th>
</tr>";
							while ($row = mysqli_fetch_array($result)) {
								...
								print("<td align = 'center' width = '1'><a href = 'viewdetail1.php?key1=" . $id . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
