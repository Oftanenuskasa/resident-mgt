		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/ho.jpg" width="530" height="80" align="center">
								<p align='center'><strong>Yearly House Registration Report</strong></p>
								<p> from <?php echo date('Y-m-d', strtotime($date . '- 1 years')); ?> -to-<?php echo date('Y-m-d'); ?>
							</strong></div>
						</p>
						<?php
			...
			<tr>
				<td bgcolor="#eee" colspan="4" align="center">
					<font color='blue'>General house registration report in one year</font>
				</td>
				<td>
			</tr>
			...
			<tr>
				<td colspan="3">Total house registered in one year</td>
