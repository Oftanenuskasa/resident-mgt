...
";
		...
		<table>
			<tr>
				<td>
					...
					<?php
					$ctrl = $_REQUEST['key1'];
					$query = "SELECT * FROM news where NewsId='{$ctrl}'";
					...
					?>
						...
						<form action='edit_new.php' method='POST'>
							<table align="center" style="width:450px; margin-top:-110px; height:200px;border-radius:16px;border:2px solid #686868" cellpadding="4">
								<tr>
									<td colspan="2" align="right"><a href="viewnew.php"><img src="image/close.png"></a></td>
								</tr>
								<tr>
									<td>News Id:</td>
								...
								<tr>
									<td>Subject:</td>
									<td><input type='text' name='subject' value="<?php echo $row1; ?>" style="width: 200;height: 30; background:#eee;" pattern="[a-zA-Z ]+" required title="Enter only alephabt"></td>
								</tr><br />
								<tr>
									<td>News Content:</td>
									<td><textarea name='content' cols="18" rows="5" style="width: 200;height: 70; background:#eee;"><?php echo $row2; ?></textarea></td>
								</tr><br />
								<tr>
									<td colspan="2" align="center"><input type='submit' name='Update' value='update' style="width: 90;height: 30; background:green;">
								</tr>
				</td>
		</table>
		</form>
	...
	if (isset($_POST['Update'])) {
		...
		$times = date('Y-m-d');
		$updat = mysqli_query($conn,"update news set Subject='$subject',NewsContent='$content',TimesOfSent='$times' where NewsId='{$id}'");
		if ($updat) {
			echo "<h4 align='center' style='width:450px;height:40;background:brown;'><font color='white'>News Updated Sucessfully.</h4></font>";
		} else
			echo "string";
	}
