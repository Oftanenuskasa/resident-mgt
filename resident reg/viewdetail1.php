		...
		<tr>
			<td width="252">
				<table border="0" bgcolor="#CCCCCC" cellspacing="0">
					<tr>
						<td width="270" height="560" valign="top">
				...
				<td>
					...
					?>
						...
						<table valign='top' align="center" style="width:470px; height:150px;border-radius:16px;border:2px solid #686868">
							<tr>
								<td></td>
								<td align="right"><a href="viewresedent.php"><img src="image/Delete.png" title="Close"></a></td>
							</tr>
							<tr>
							<tr>
								<td rowspan="3"><img src="downlod/photo/<?php echo $pimg; ?> " width='120' height='100'></td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>DateOfBirth:</b>
								</td>
