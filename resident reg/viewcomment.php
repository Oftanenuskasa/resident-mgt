...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<left>
			...
			if ($no > 0) {
				echo "<h4 style='width:530px;height:30px;background:brown'><font color='white'><h3>Welcome " . $ful . " you have <font color='blue'>" . $no . "</font> new comment.</h4></font>
";
				echo "<table border=0 >";
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					echo "<tr><th>from</th><th>Date</th><th>Comment</th><th colspan=3 width=10%>Action</th></tr>";
					echo "<tr><td width=5% align='center'> $row[1] </td><td width=15%> $row[2] </td><td width=15%> $row[3] </td>" .

						"<td width=4% align = 'center' > <a href='deletecomment.php?key2=" . $ctr2 . "' onClick=\"return confirm('Are you shure to delete the comment.')\">
	 <img src='image/Delete.png'  alt='delete'></a></td></tr>";
				...
				echo "<h4 style='width:550px;height:40px; background:red;'><font color='white'><font color='grean'size='6'>(!) </font>No new comment send form user.</font></h4>";
