...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		if ($r) {
			...
			echo "<h4 style='width:525px;height:50px;background:brown;'><font color='white'>Dear " . $ful . " the request for new register to the system is succesfully Rejected.</font> </h4>";
		}


		mysqli_close($conn); ?></td>
		<a href="register_requset.php"><img src="image/b.png" width="40" title="cleck here to back to requst list."> </a>
