...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<?php
		$id1 = $_REQUEST['key1'];
		$result = mysqli_query($conn,"SELECT * FROM clearance_requset  where send='$id1' and seen='0'");

		echo "<table id='vtable' style='width:520px;border:2px solid #eee;' align='center' valign='top'><font color=white>
<tr>
<th bgcolor='#eee'><font color='black' size='2'> From </th>
<th bgcolor='#eee'><font color='black' size='2'>Purpose          </th>
<th bgcolor='#eee'><font color='black' size='2'> Police sarvice file</th>
<th bgcolor='#eee'><font color='black' size='2'>interprise file</th>
<th bgcolor='#eee'><font color='black' size='2'>Approve          </th>
<th bgcolor='#eee'><font color='black' size='2'>Reject          </th>
</tr>";
		while ($row = mysqli_fetch_array($result)) {
			...
			echo $row["content"];
			echo "</td>";
			echo "<td align=center width='20%'><a title='Click here to download in file.' href='downlod.php?id={$row['polce_cerifcate']}'>Downlod </a>";
			echo "<td align=center width='20%'><a title='Click here to download in file.' href='downlod.php?id={$row['smll_cirtifcate']}'>Downlod </a>";
			echo ("<td align = 'center' width = '4%'><a href = 'clearance.php?name=" . $id . "&username=" . $id1 . "' onClick=\"return confirm('Are you shure to prepare claerance.')\"><img src = 'image/app.png' width='30'border = '0' title='Rplay';'></img></a>
    </td>");
			echo ("<td align = 'center' width = '4%'><a href = 'clerance_disapprove.php?name=" . $name . "' onClick=\"return confirm('Are you shure to Reject the request.')\"><img src = 'image/close.png' width='25'border = '0' title='Rplay';'></img></a>
    </td>");
			echo ("</tr>");
		}
		echo ("</table>");
		echo "<a href = 'viewclerance_request.php'><img src = 'image/b.png' width='40'border = '0' title='Back to view request clerance page';'></img>";
