	...
	<table border="0" width="92%" cellspacing="0">
		...
		<tr>
			<td id="dropdown" colspan="3">
				...
				<li><a href="addemp.php"><b><img src="image/bel/reg.jpg" width="20" height="17">Add Employee</b></a>
				</li>
				<li><a href="change_password.php"><img src="image/ch.jpg" width="25" height="17"><b>Change Password</b></a></li>
						...
						<td width="270" height="470" valign="top">
							<table border="0" width="259" cellspacing="0">
								<tr>
									...
									if (!$profile) {
										echo "<td  align='lefet' colspan='2' style='background: #eee'><img src='image/z.jpg' style='border-radius: 80%;width: 130px;height: 100px;'>
...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		<left>
			...
			$num = mysqli_num_rows($result);
			?>
			<h3 align="center" style="width: 540px;height:50px;background: brown ">
				<font color='white'> Welcome: <font color=''> <?php echo $ful ?></font>
				</font>
				</h4>
				<h4 align="left"><img src="image/g.png" width="30" height="20">You have <font color="blue">
						(<?php echo $co ?>)</font> new comment from user: <a href="view admin comment.php"><b>View </b>
					</a></h4>
				<h4 align="left"><img src="image/g.png" width="30" height="25">You have <font color="blue">
						(<?php echo $num ?>)</font> new request for create account. <a href="accountnoti.php"><b>
							View</b> </a></h4>
				<?php
				$result = mysqli_query($conn,"select * from User");
				$co = mysqli_num_rows($result);
				$result1 = mysqli_query($conn,"select * from User where Position='Record Officer'");
				$co1 = mysqli_num_rows($result1);
				$result2 = mysqli_query($conn,"select * from User where Position='resident'");
				$co2 = mysqli_num_rows($result2);
				$result3 = mysqli_query($conn,"select * from User where Position='Chairman'");
				$co3 = mysqli_num_rows($result3);
				$result4 = mysqli_query($conn,"select * from User where status='1'");
				$co4 = mysqli_num_rows($result4);
				$result5 = mysqli_query($conn,"select * from User where status='0'");
				$co5 = mysqli_num_rows($result5);
				$result6 = mysqli_query($conn,"select * from User where Position='Administrator'");
				$co6 = mysqli_num_rows($result6); ?>
				<TABLE align='center' bgcolor='' bordar=1>
					<tr>
						<th bgcolor="">General information about user</th>
					</tr>
					<tr>
						<td>Administrator:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co6 ?>
						</td>
					</tr>
					<tr>
						<td>Record officer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co1 ?>
						</td>
					</tr>
					<tr>
						<td>Resident:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co2 ?>
						</td>
					</tr>
					<tr>
						<td>Chairman:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co3 ?>
						</td>
					</tr>
					<tr>
						<td>Deactivated user:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co5 ?>
						</td>
					</tr>
					<tr>
						<td>Activated user:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $co4 ?>
						</td>
					</tr>
					<tr>
						<td>Total
