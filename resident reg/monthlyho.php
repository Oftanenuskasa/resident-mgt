...
";
		...
		<table id="contentbox" border="1" width="100%">
				...
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/ho.jpg" width="100%" height="80" align="center">
								<p align='center'><strong>Monthly House Registration Report<p> from <?php echo date('Y-m-d', strtotime($date . '- 1 month')); ?> -to-<?php echo date('Y-m-d'); ?>
									</strong></div>
						</p>
						<?php
						...
						if ($con < 1) {
							echo "<font color='red'>You have no house register in the date " . $a . "</font><br>";
						} else {
						?>
							<table width="530" border="0.5" align="center" cellpadding="0" cellspacing="0">
								<thead>
									<tr bgcolor="#eee" style="margin-bottom:10px;">
										<th width="120">
											<div align="center">Owner Id</div>
										</th>
										<th width="115">
											<div align="center">House No</div>
										</th>
										<th width="113">
											<div align="center">House Type</div>
										</th>
										<th width="130">
											<div align="center">Date Of Registration</div>
										</th>
									</tr>
								</thead>
								<tbody>
			...
			<tr>
				<td bgcolor="#eee" colspan="4" align="center">
					<font color='blue'>General house registrtion report in one month</font>
				</td>
				<td>
			</tr>
			...
			<tr>
				<td colspan="3">Total house registered in one month</td>
	...
	<br>
	<div style="margin-left:90%; width:50px;  text-align:center;"><a href="housereport.php"><img src="image/b.png" width="40" title="click here to back to the serarch page"></a></div><br>
