...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<font color='white'>
			<h4 align="left" style="width: 550px;height: 58px;background:brown">
				<font color="grean" size='5'>(?)</font> Welcome &nbsp;<font color=''><?php echo $ful; ?></font>&nbsp; please select the date to generate house registration report daily,weekly,monthly and yearly.
			</h4>
		</font>

		<a href="houreport.php">Daily Register house</a><br><br>&nbsp;&nbsp;&nbsp;<a href="weeklyho.php">Weekly Register house</a><br><br>&nbsp;&nbsp;&nbsp;<a href="monthlyho.php">Monthly Register house</a><br><br>&nbsp;&nbsp;&nbsp;<a href="yearho.php">Yearly Register house</a>
