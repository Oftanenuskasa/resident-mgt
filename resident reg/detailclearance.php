		...
		<tr>
			<td width="252">
				<table border="0" bgcolor="#CCCCCC" cellspacing="0">
					<tr>
						<td width="270" height="680" valign="top">
		...
		<table>
			<tr>
				<td>
					...
					?>
						<a href="javascript:Clickheretoprint()"><img src="image/DPIC_36483.jpg"></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href='uploadclearance.php?name=<?php echo $row11 ?>'><strong><input type="submit" value="Upload Clearance"> </strong></a>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="viewclearance.php"><strong><img src="image/b.png" width="40"> </strong></a>
						<table border="1" width="100%">
							<tr>
								<td>
									<br>
									<div id="print_content">
										<p align="center" width="540px"><img src="image/as.jpg" width="100%" height="80"> </p>

										<table valign='top' align="center" style="width:530px; height:150px;">
											<tr>
												<td>Photo</td>
												<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
												<td align="left">
													<font face="times new roman" color="#000000" size="3"><b>DateOfTaken:</b><u><?php echo $row7 ?></u>
												</td>
											</tr>
											<tr>
												<td rowspan="4"><img src="downlod/photo/<?php echo $row9; ?>" width='120' height='100'></td>
											</tr>
											<tr>
												<td>
													<font face="times new roman" color="#000000" size="3"><b>Id Number:</b></font>
												</td>
												<td><?php echo $row0 ?></td>
											</tr>
											<tr>
											...
											<td>
												<font face="times new roman" color="#000000" size="3"><b>jop:</b>
											</td>
											<td><?php echo $row8 ?></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="1">
									<font face="times new roman" color="#000000" size="3"><b>Reason_Of_Clearance:</b>
								</td>
								<td colspan="2"><?php echo $row6 ?></td>
							<tr>
							<tr>
								<td>
									<font face="times new roman" color="#000000" size="3"><b>Approved by:</b></font><?php echo $ful ?>
								</td>
							</tr>
			</tr>
			<tr>
