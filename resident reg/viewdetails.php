	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<left>
			<table>
				<tr>
					<td>
						<div><b>View House Detail information</b></div>
						<hr />
						...
						if ($count == 1) {
							...
							$query1 = "SELECT * FROM idcard where id_number='{$row0}'";
						...
						?>
							<br><br>
							<table valign='top' align="center" style="width:400px; height:150px;border-radius:16px;border:2px solid #686868">
								<tr>
									<td></td>
									<td align="right"><a href="viewhouse.php"><img src="image/Delete.png" title="Close"></a></td>
								</tr>
								<tr>
									<td align="left"><img src="downlod/photo/<?php echo $po; ?> " width='130' height='100'></td>
								</tr>
								<tr>

									<td>
										<font face="times new roman" color="#000000" size="3"><b>Owner Id Number:</b></font>
									</td>
									<td><?php echo $row0 ?></td>
								</tr>
								<tr>
									<td>
										<font face="times new roman" color="#000000" size="3"><b> Owner First name:</b></font>
									</td>
									<td><?php echo $fname ?></td>
								</tr>
								<tr>
									<td>
										<font face="times new roman" color="#000000" size="3"><b>Owner Middle name:</b></font>
									</td>
									<td><?php echo $mname ?></td>
								</tr>
								<tr>
									<td>
										<font face="times new roman" color="#000000" size="3"><b>Owner Sex:</b></font>
									</td>
									<td><?php echo $sex ?></td>
								</tr>
								<tr>
									<td>
										<font face="times new roman" color="#000000" size="3"><b>Owner jop</b></font>
									</td>
									<td><?php echo $jop ?></td>
								</tr>
								<tr>
				...
				<tr>
					<td>
						<font face="times new roman" color="#000000" size="3"><b>Sequre meater:</b>
					</td>
					<td><?php echo $row3 ?></td>
				</tr>
				<tr>
					<td>
						<font face="times new roman" color="#000000" size="3"><b>House_Type:</b>
					</td>
					<td><?php echo $row4 ?></td>
				</tr>
				<tr>
					<td>
						<font face="times new roman" color="#000000" size="3"><b>DateOfRegistration:</b>
					</td>
					<td><?php echo $row5 ?></td>
				</tr>
			</table>
