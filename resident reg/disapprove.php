...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		if ($r) {
			...
			$query1 = "INSERT INTO `noti`(`id`, `from`, `content`, `send`, `seen`, `date`, `username`) VALUES ('none','" . $username . "','The request for register his/her wife/hasband is not accepted ','$sender','0','$da','none')";
			$ress = mysqli_query($conn,$query1);
			if ($ress) {

				echo "<h4 style='width:530px;height:30px;background:brown;><font color='white'>The requset succesfully Rejected.</font><br>";
			}
		}

		mysqli_close($conn); ?>
		<a href="approve_register.php"><img src="image/b.png" title="Click here to back to approve_register page."></a>
