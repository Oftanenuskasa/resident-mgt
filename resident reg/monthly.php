		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/repo1.jpg" width="100%" height="80" align="center"></strong><BR><strong> monthly Clearance Preparation Report</strong></a>
							&nbsp;<strong><?php echo date('Y-m-d', strtotime($date . '- 1 month')) . '-to-' . date('Y-m-d'); ?>
						</div>
						...
						$query_total = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b'";
			...
			<tr>
				<td colspan="7" align="center" bgcolor="#eee">
					<font color='black'>General clerance report in one month.</font>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4">The total number of Clearance prepare in one month:</td>
