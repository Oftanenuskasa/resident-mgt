...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		if ($cont) {
			echo "<h4 align='center' style='width:540px;height:30px;background:brown;'><font color='white' size='3'> Dear <font color=''>" . $ful . "</font> you have (" . $cont . ") new notifcation.</font></h4>";
			echo "<table id='vtable' style='width:550px;border:0px solid #eee;' align='left' valign='top'><font color=blue>
<tr>
<th bgcolor='white'><font color='blue' size='2'> Sender Name </th>
<th bgcolor='white'><font color='blue' size='2'>Content          </th>
<th bgcolor='white'><font color='blue' size='2'>sent date          </th>
<th bgcolor='white'><font color='blue' size='2'>Upload          </th>
<th bgcolor='white'><font color='blue' size='2'>Delete          </th>
</tr>";
			$cont = 'The clerance is prepared.please bring your photo or upload then you can came and take:';
			while ($row = mysqli_fetch_array($result)) {
				...
				echo "</td>";
				if ($ctrl2 == $cont) {
					echo ("<td align = 'center' width = '1'><a href = 'uploadpho.php'><img src = 'image/do.png' width='30' border = '0' title='click here to upload photo';'></img></a>    </td>");
				} else {
					echo "<td></td>";
				}
				echo ("<td align = 'center' width = '1'><a href = 'del_noti.php?key=" . $id . "'><img src = 'image/close.png' width='30' border = '0' title='Delete the data';'></img></a>
    </td>");
				echo ("</tr>");
			}
			echo ("</table>");
		} else
			echo "<h4 align='left' style='width:540px;height:40px;background:brown'><font color='white'><font color='grean' size='6'>(!)</font> You have no new notifcation.</font></h4>";
		mysqli_close($conn);
		?>
