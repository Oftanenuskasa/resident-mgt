								...
								<tr>
									<td>
										...
										if (isset($_POST['search'])) {
											$idno = $_POST['searchs'];
											$sql = "SELECT * FROM marriage WHERE mrid='{$idno}'";
...
<th>Delete</th>
												...
												while ($row = mysqli_fetch_array($result)) {
													$ctrl = $row['mrid'];
													print("<tr>");
													print("<td>" . $row['mrid'] . "</td>");
													print("<td>" . $row['husbandfulname'] . '&nbsp;' . $row['wifefulname'] . '&nbsp;' . $row['evidence1fulname'] . "</td>");
													print("<td align = 'center' width = '1'><a href = 'view_marriage.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
         <td align = 'center' width = '1'><a href = 'edit_marriage.php?key1=" . $ctrl . "'><img src = 'image/Edit.png' width='25px' height='25px' title='Edit' ></a></td>
		<td align = 'center' width = '1'><a href = 'delete_marriage.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/Delete.png' title='Delete'></img></a></td>
		");
													print("</tr>");
												}
												print("</table>");
