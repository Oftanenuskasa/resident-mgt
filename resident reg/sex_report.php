...
jpg" width="15%" height="140"></td>
    ...
    <tr>
      <td id="dropdown" colspan="3">
        ...
        <li><a href="#"><em><strong>Prepare</strong> </em></a>
          <ul class="sub1">
              ...
              <table>
                <tr>
                  <td>
                    ...
                    <div><b><strong>
                          <center>Durame city idcard report Form</center>
                        </strong></b></div>
                    <hr />
                    <fieldset>
                      <legend align="center">
                        <div class="legend"><b>idcard report----------------------------------------------------</b></div>
                      </legend>
                      <br>
                      <div>
                        <html>
...
echo"<li><a  href='noti.php'>$num &nbsp;</a></li>"; */
                ...
                <div id="image">
                  <div id="sidebar1">
                    ...
                    $ner = "Female";
                    $m = 18;
                    $mnerquery = "SELECT* FROM idcard where sex='" . $ner . "'";
                    $mnerres = @$db->query($mnerquery);
                    $mnernum_results = $mnerres->num_rows;
                    $mdipquery = "SELECT* FROM idcard where sex='" . $dip . "'";
  ...
  <tr>
    <td>
      ...
      <div id="print_content">
        ...
        <div style="margin-left:20%; width:50px;  text-align:center;"><a href="idcardreport.php"><img src="image/btn_back.gif"></a></div>
        <br>
...
<td width="300" height="400" valign="top" bgcolor="#CCCCCC" id="mele">
