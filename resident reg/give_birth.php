...
<body onLoad="timeimgs('1');">
	<table border="0" width="1299" cellspacing="0">
		...
		<tr>
			<td>
				<table border="0" bgcolor="orange" cellspacing="0">
					<tr>
								...
								<tr>
									<td>
										...
										<form action="give_birth.php" onsubmit='return formValidator()' method='POST'>
											<table>
												<tr>
													<td class="search">Enter Birth id:</td>
										...
										if (isset($_POST['search'])) {
											$idno = $_POST['searchs'];
											$sql = "SELECT * FROM birth WHERE brid='{$idno}'";
...
<th>Delete</th>
												...
												while ($row = mysqli_fetch_array($result)) {
													$ctrl = $row['brid'];
													print("<tr>");
													print("<td>" . $row['brid'] . "</td>");
													print("<td>" . $row['firstname'] . '&nbsp;' . $row['middlname'] . '&nbsp;' . $row['lastname'] . "</td>");
													print("<td align = 'center' width = '1'><a href = 'view_birth.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
         <td align = 'center' width = '1'><a href = 'edit_birth.php?key1=" . $ctrl . "'><img src = 'image/Edit.png' width='25px' height='25px' title='Edit' ></a></td>
		<td align = 'center' width = '1'><a href = 'delete_birth.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/Delete.png' title='Delete'></img></a></td>
		");
													print("</tr>");
												}
												print("</table>");
