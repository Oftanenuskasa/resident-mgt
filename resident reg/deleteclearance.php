	...
	<table border="0" width="92.8%" cellspacing="0">
		...
		<tr>
			...
			<th width="1047" height="436" valign="top" bgcolor="white"><br>
				...
				include('config.php');
				$ctrl = $_REQUEST['key1'];
				$result = mysqli_query($conn,"delete from clearance where  IdNumber = '$ctrl'");
				if ($result) {

					echo "<h4 style='width:540px;height:40px;background:brown;'> <font color='white'> The clearance Succesfully deleted</font></h4>";
				}

				?>
				<a href="viewclearance.php"><img src="image/b.png"></a>
