...
jpg" width="15%" height="150"></td>
		...
		<tr>
			<td id="dropdown" colspan="3">
				...
				<li><a href="addemp.php"><b><img src="image/bel/reg.jpg" width="20" height="17">Add Employee</b></a></li>
...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		<?php
		$conn = mysqli_connect("localhost", "root", "nasis") or die(mysqli_error($conn));
		$sdb = mysqli_select_db($conn,"resident") or die(mysqli_error($conn));
		if (isset($_GET['status'])) {
			$status = $_GET['status'];

			$select_status = mysqli_query($conn,"select * from user where Username='$status'");
			while ($row = mysqli_fetch_object($select_status)) {
				...
				$update = mysqli_query($conn,"update user set status='$status2' where Username='$status' ");
				if ($update) {
					echo "<h4 style='width:500px;height:30px;background:brown'><font color='white'>The action preformed succesfully.</font></h4>";
				} else {
	...
	<td width="50" height="100" valign="top">
		...
		<table border="0" bgcolor="white" width="257" height="436" cellspacing="0" cellpadding="5">
			...
			<tr>
				<td align="left">The mission of 01 kebele is that</td>
			</tr>
			...
			<tr>
				<td align="left"> The vision of 01 kebele is that,to </td>
			</tr>
			<tr>
	...
	<tr>
		<td colspan="3" height="25">
			<table border="0" align="left" width="92%" bgcolor="#CCCCCC" cellspacing="0">
				<tr>
					<td align="='center'">
						<font face="Times New Roman" color="black"><b>01 KEBELE RESIDENCE RECORD MANAGMENT SYSTEM &copy; 2024 COPY RIGHT RESERVED !!!</b>
						</font>
					</td>
				</tr>
			</table>
