...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<center>
			...
			<font color='white'>
				<h4 align="left" style="width: 540px;height: 50px;background:brown

;">
					<font color='grean' size="5">(?)</font> Dear <font color=""> &nbsp;<?php echo $ful; ?> </font>&nbsp;Please Click the link!!
					To genrate clearance report that prepare Daily,weekly,monthly and yearly .
				</h4>
			</font>
			<a href="daily.php">Daily Register Clearance</a><br><br>&nbsp;&nbsp;&nbsp;<a href="weekly.php">Weekly Register Clearance</a><br><br>&nbsp;&nbsp;&nbsp;<a href="monthly.php">Monthly Register Clearance</a><br><br>&nbsp;&nbsp;&nbsp;<a href="year.php">Yearly Register Clearance</a>
