		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/hreport.png" width="100%" height="80" align="center">
								<p align='center'><strong>Daily House Registration Report on <?php echo date('Y-m-d'); ?>
									</strong></div>
						</p>
						<?php
						$a = date('Y-m-d');
			...
			<tr>
				<td bgcolor="blue" colspan="3" align="center">
					<font color='white'>General house registrtion report in today</font>
				</td>
				<td>
			</tr>
			...
			<tr>
				<td colspan="3">Total house registered in today</td>
				<td colspan="1" bgcolor="#eee">
