...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<div><b>Search IdCard by Id number to give or Edit.</b></div>
		<hr />
		<?php
		$dat = date('Y-m-d');
		$id = $_REQUEST['id'];
		...
		<form action="giveidcard.php" onsubmit='return formValidator()' method='POST'>
			<table>
				<tr>
					...
					<td><input type="text" name="searchs" size="40px" value="<?php echo $id; ?>" /></td>
		...
		if (isset($_POST['search'])) {
			...
			if ($count > 0) {
				echo "<center>";
				echo "<table border='1' style='width:520px;border-radius:10px;' align='center'>
<tr>
...
<th>Edit</th>
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					print("<td align = 'center' width = '1'><a href = 'viewid.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
         <td align = 'center' width = '1'><a href = 'edit_id.php?key1=" . $ctrl . " & name=" . $name . "'><img src = 'image/Edit.png' width='25px' height='25px' title='Edit' ></a></td>
