...
<body onload="parent.member()" onload="noBack();" onpageshow="if(event.persisted) noBack(); ">
	<br>
	<table border="0" border-clolor:#eee width="92%" cellspacing="0">
		<tr>
			...
			<td id="dropdown" colspan="3">
				<font size="2.75">
					...
					<li>
						...
						?>
					<li>
						<font size="2.75"><a href="register_noti.php"><img src="image/mail.png" width="20" height="20"><em><strong>Notifcation<font color='red'>(<?php echo $con; ?>)</font></strong></em></a>
					</li>
					<li>
				...
				<table border="0" bgcolor="#F0F8FF" cellspacing="0" id="mele">
					<tr>
						...
						<td width="100%" height="380" valign="top" bgcolor="WHITE"><br>
							...
							<pre><font size="6" face="Times New Roman">

Accordingly, Durame City is empowered to handle
many services like  Giving ID cards,renew Id card
clearance services,registration of resident
and house etc.

Durame City is a well built city always working to
achive residents wants .its very organised working
environment with a very hard working employees always 
on stand by to serve residents.
					...
					if (isset($_POST['submitMain'])) {
						...
						if ($result->num_rows > 0) {
							...
							echo '<div align="center"><strong><font color="red">Account Type, User Name & Password do not match !!</font></strong></div>';
						}
						$stmt->close();
						$conn->close();
					}
