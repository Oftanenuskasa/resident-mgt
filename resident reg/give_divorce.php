								...
								<tr>
									<td>
										...
										if (isset($_POST['search'])) {
											$idno = $_POST['searchs'];
											$sql = "SELECT * FROM divorce WHERE ddrid='{$idno}'";
...
<th>Delete</th>
												...
												while ($row = mysqli_fetch_array($result)) {
													$ctrl = $row['ddrid'];
													print("<tr>");
													print("<td>" . $row['ddrid'] . "</td>");
													print("<td>" . $row['mrid'] . '&nbsp;' . $row['reasonofdivorce'] . '&nbsp;' . $row['nameofcourt'] . "</td>");
													print("<td align = 'center' width = '1'><a href = 'view_divorce.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/search.png' title='View Detail'></a></td>
         <td align = 'center' width = '1'><a href = 'edit_divorce.php?key1=" . $ctrl . "'><img src = 'image/Edit.png' width='25px' height='25px' title='Edit' ></a></td>
		<td align = 'center' width = '1'><a href = 'delete_divorce.php?key1=" . $ctrl . "'><img width='25px' height='25px' src = 'image/Delete.png' title='Delete'></img></a></td>
		");
													print("</tr>");
												}
												print("</table>");
