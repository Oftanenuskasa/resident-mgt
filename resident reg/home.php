                    ...
                    <table border="0" bgcolor="#F0F8FF" cellspacing="0" id="mele">
                        <tr>
                            ...
                            <td width="100%" height="380" valign="top" bgcolor="WHITE">
                                <br>
                                <div align="center">
                                    <h2 style="color: blue; width: 530px; height: 80px; background: #65FE08;" >
                                        Welcome to Durame City Resident Record Management System
                                    </h2>
                                    <p style="font-size: 16px;">
                                        Durame City was established in 2010 E.C. This city is found in southeastern Ethiopia town.
                                        <a href="more.php" style="color: red;">Read more</a>
                                    </p>
                                </div>
                            </td>
                            ...
                            <td width="100%" height="400" valign="top">
                                <table border="0" bgcolor="white" width="257" height="490" cellspacing="0" cellpadding="5">
                                    <form action="home.php" method="post" name="frm_login" id="frm_login">
                                        <tr>
                                            <td bgcolor="#4f90ff" colspan="3"><img src="image/login.png" width="25" color="black"> Login</td>
                                        </tr>
                                        <tr>
