...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		include('config.php');
		$ctrl = $_REQUEST['key1'];
		$result = mysqli_query($conn,"delete from news where  NewsId = '$ctrl'");
		echo "<font color='white'> <h4 align='left' style='width: 540px;height: 50px; background: red'><font color='grean' size='5'>(?)</font> The news in the id $ctrl is  succefully deleted.</h4></font>";


		?>

		<a href="viewnew.php"><img src="image/b.png"></a>
