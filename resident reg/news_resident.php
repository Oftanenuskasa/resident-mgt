...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br><?php
																	...
																	if ($con > 0) {
																		echo "<h3 align='left' style='width:540px;height:50px;background:brown'><font color='white' > You have  " . $con . " new news posted from chairman. </font></h4>";
																		while ($rel = mysqli_fetch_array($result)) {
																			//$temp=$rel[4];
																			echo "<h2 align='center' style='background:#606060;color:#FFDEAD;'>Announcement news:</h1><br/>";
																			...
																			echo "<font style='font-family:verdana,arial,helvetica,sans-serif;font-size:12px;line-height:18px;left-align:justify;padding-left:20px; margin-top:2px;'>Posted on " . $rel[3] . "</font></br>";
																			echo "<h4 align='left'>___________________________________________________________</h4>";
																			//echo '$_SESSION['price']';
																			echo "</fieldset>";
																		}
																	} else
																		echo "<h4 align='left' style='width:540px;height:40px;background:brown;'><font color='grean' size='6'>(!)</font> <font color='white'>You have no new news posted from chairman.</font></h4> ";
	...
	<td width="50" height="100" valign="top">
		<table border="0" bgcolor="white" width="257" height="436" cellspacing="0" cellpadding="5">
			...
			<tr>
				<td align="left"> durame city kebele.</td>
			</tr>
			<tr>
				<td align="left"> </td>
			</tr>
