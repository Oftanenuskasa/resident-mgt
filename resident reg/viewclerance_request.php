...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<?php
		$result = mysqli_query($conn,"SELECT * FROM clearance_requset where seen=0");
		$count = mysqli_num_rows($result);
		if ($count > 0) {
			echo "<font color='white'><h4 align='left' style='width:540px; height:50px;background:brown;'> Dear <font color=''>" . $ful . "</font> you have " . $count . " new request for clerance preparation.Click the name to see the detail of request. </h4><font>";
			...
			while ($row = mysqli_fetch_array($result)) {
				$ctrl = $row['send'];
				echo "<tr>
<th bgcolor='#eee'><font color='black' size='3'> Requset " . $i . " send from: </th>
</tr>";

				echo "<tr>";
				print("<td align = 'center' width = '1' color='red'><a href = 'viewclerancedetail.php?key1=" . $ctrl . "'>$ctrl</a></td>");
			...
			echo "<h4 style='width:540px; height:40px;background:red;' align='left'><font color='white'><font color='grean' size='5'>(!)</font>You have no new requset for clerance preparation.</font></h4>";
		}
		mysqli_close($conn);
		?>
