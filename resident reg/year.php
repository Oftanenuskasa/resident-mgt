...
";
		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/repo1.jpg" width="100%" height="80" align="center"></strong><BR><strong> Yearly Clearance Preparation Report</strong></a>
							&nbsp;<strong><?php echo date('Y-m-d', strtotime($date . '- 1 years')) . '-to-' . date('Y-m-d'); ?>
						</div>
						...
						$query1 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Farmer'";
						$result1 = mysqli_query($conn, $query1);
						$fmale_far = mysqli_num_rows($result1);
						
						$query2 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Farmer'";
						$result2 = mysqli_query($conn, $query2);
						$male_far = mysqli_num_rows($result2);
						$total_far = $fmale_far + $male_far;
						
						$query3 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Student'";
						$result3 = mysqli_query($conn, $query3);
						$fmale_stu = mysqli_num_rows($result3);
						
						$query4 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Student'";
						$result4 = mysqli_query($conn, $query4);
						$male_stu = mysqli_num_rows($result4);
						$total_stu = $fmale_stu + $male_stu;
						
						$query5 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Teacher'";
						$result5 = mysqli_query($conn, $query5);
						$fmale_th = mysqli_num_rows($result5);
						
						$query6 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Teacher'";
						$result6 = mysqli_query($conn, $query6);
						$male_th = mysqli_num_rows($result6);
						$total_th = $fmale_th + $male_th;
						
						$query7 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Doctor'";
						$result7 = mysqli_query($conn, $query7);
						$fmale_doc = mysqli_num_rows($result7);
						
						$query8 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Doctor'";
						$result8 = mysqli_query($conn, $query8);
						$male_doc = mysqli_num_rows($result8);
						$total_doc = $fmale_doc + $male_doc;
						
						$query9 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Guard'";
						$result9 = mysqli_query($conn, $query9);
						$fmale_ga = mysqli_num_rows($result9);
						
						$query10 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Guard'";
						$result10 = mysqli_query($conn, $query10);
						$male_ga = mysqli_num_rows($result10);
						$total_ga = $fmale_ga + $male_ga;
						
						$query11 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Phd'";
						$result11 = mysqli_query($conn, $query11);
						$fmale_ph = mysqli_num_rows($result11);
						
						$query12 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Phd'";
						$result12 = mysqli_query($conn, $query12);
						$male_ph = mysqli_num_rows($result12);
						$total_ph = $fmale_ph + $male_ph;
						
						$query13 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Master'";
						$result13 = mysqli_query($conn, $query13);
						$fmale_ms = mysqli_num_rows($result13);
						
						$query14 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Master'";
						$result14 = mysqli_query($conn, $query14);
						$male_ms = mysqli_num_rows($result14);
						$total_ms = $fmale_ms + $male_ms;
						
						$query15 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Female' AND job='Other'";
						$result15 = mysqli_query($conn, $query15);
						$fmale_oth = mysqli_num_rows($result15);
						
						$query16 = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b' AND Sex='Male' AND job='Other'";
						...
						$query_all = "SELECT * FROM clearance WHERE Date_of_Taken BETWEEN '$a' AND '$b'";
			...
			<tr>
				<td colspan="7" align="center" bgcolor="#eee">
					<font color='black'>General clearance report in one year.</font>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4">The total number of Clearance prepare in one year:</td>
	...
	<?php
							...
							echo "<h4 style='width:540px;height:30px;background:;'><font color='red'>No clerance prepared beteewn this date.</font></h4>";
						}
	?>
