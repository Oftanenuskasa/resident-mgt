...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		echo "<font color='white'><h4 style='width:550px;height:37px; background:brown'>This is <font color=''>" . "$name </font> request detail for register.please approve or reject.</h4></font>";
		echo "<table id='vtable' style='width:550px;border:0px solid #eee;' align='lef' valign='top'><font color=white>
<tr>
<th bgcolor='#eee'><font color='blue' size='2'>  Sender name </th>
<th bgcolor='#eee'><font color='blue' size='2'>Purpose </th>
<th bgcolor='#eee'><font color='blue' size='2'>	Clearance </th>

<th bgcolor='#eee'><font color='blue' size='2'>Approve </th>
<th bgcolor='#eee'><font color='blue' size='2'>Reject </th>
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo $row["content"];
			echo "</td>";
			echo "<td align=center><a title='Click here to download in file.' href='downlod.php?id={$row['cirtficate']}'>Downlod </a>";
			echo ("<td align = 'center' width = '1'><a href = 'newapprove.php?id=" . $list . "' onClick=\"return confirm('Are you shure approve the $ctrl requset.')\"><img src = 'image/app.png' border = '0' title='approve registration' width='40';'></img></a>
    </td>");
			echo ("<td align = 'center' width = '1'><a href = 'newdisapprove.php?content=" . $list . "' onClick=\"return confirm('Are you shure disapprove $ctrl request.')\"><img src = 'image/remove.png' width='30' border = '0' title='reject registratio';'></img></a>
    </td>");
			echo ("</tr>");
		}
		echo ("</table>");
		...
		<a href="register_requset.php"><img src="image/b.png" width="40"> </a>
