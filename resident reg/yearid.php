...
";
		...
		<table id="contentbox" border="1" width="100%">
			<tr>
				<td>
					...
					<div id="print_content">
						<div align="center" style="margin-top:10px;"><strong><img src="image/repo.jpg" width="100%" height="80" align="center"></strong><BR><strong> Yearly Idcard Preparation Report </strong></a>
						</div>
						...
						<?php
						$a = date('Y-m-d', strtotime($date . '- 1 years'));
						$b = date('Y-m-d');
			...
			<tr>
				<td colspan="7" align="center" bgcolor="#eee">
					<font color='black'>General Idcard report prpared in one year.</font>
				</td>
			</tr>
			...
			<tr>
				<td colspan="4">The total number of Id card prepared in one year :</td>
	...
	<?php
							...
							echo "<font color='black'>No Idcard prepared between this date.</font>";
						}
	?>
	</td>
	</tr>
