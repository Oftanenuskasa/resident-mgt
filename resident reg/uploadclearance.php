...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<div><b>Upload Clerance to user</b></div>
		<hr />
		<?php
		$id = $_REQUEST['name'];
		?>
		<br><br><br><br><br><br><br><br><br><br>
		<form action='uploadclearance.php' method='POST' enctype="multipart/form-data">
			<table valign='top' align="center" style="width:400px; margin-top:-110px; margin-top:-220px; height:150px;border-radius:16px;border:2px solid #686868">
				<tr>
					<td colspan="2" align="right"> <a href="viewclearance.php"><img src="image/close.png" width="30" title="Click here to back serach menu"></a></td>
				</tr>
				<tr>
					<td>Id number:</td>
		...
		if (isset($_POST['update'])) {
			...
			if ($co == 0) {
				...
				$updat = mysqli_query($conn,"INSERT INTO `upload`(`id`, `sendto`, `file`) VALUES('none','$id1','" . $photo . "')") or die(mysqli_error($conn));
				if ($updat) {
					echo "<h4 align='center'><font color='green'>....................................................................................................</h4></font>";
					echo "<h4 align='center'><font color='green'> Clearance Uploaded Sucessfully !!</h4></font>";
					echo "<h4 align='center'><font color='green'>.....................................................................................................</h4></font>";
				} else
					echo $id1;
			} else {
				echo "<h4 align='center'><font color='green'>....................................................................................................</h4></font>";
				echo "<h4 align='center'><font color='green'> you have Uploaded the  Clearance before  !!</h4></font>";
				echo "<h4 align='center'><font color='green'>.....................................................................................................</h4></font>";
			}
		}
