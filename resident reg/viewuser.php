		...
		<tr>
			<td width="252" height='300'>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0" valign="top">
					<tr>
						<td width="270" height="723" valign="top">
	...
	<th width="100%" height="300" valign="top" bgcolor="white"><br>
		...
		<fieldset>
			...
			<div>
				...
				<table style="margin-top:-10px" width="500px" border="0" color:#606060 cellpadding="0" id="myTable" cellspacing="0" background-color:#CCCCCC "  ><!--content table -->
<tr ><td><form action="viewuser.php" method="post">
					User Name<input type="text" name="myInput" class="form-control 
     ...
     <td  bgcolor="	#ffffff "valign="top" height="150px" width="100%" margin-top="0px" border="0px" align-top="0px"><!--center -->
	  <div id="pagetitle" padding-left="89"><!--enstanceBeginEditable name="pagetitle" --><b>View detail , Edit , Activate, Deactivate<br> </b><!--enstanceEndEditable --></div>
     	</br><div id="contentarea1">
<table border="1" style="width:100%; height:100px;border:1px solid black;border-radius:10px;" 
        id="myTable" align="left">
<tr>
<th>Name</th>
<th>User Name</th>
...
<th>Activate <br>(Deactivate)</th>
					...
					?>
								<tr>
									<td><?php echo $fu; ?></td>
									<td><?php echo $user; ?></td>
									<td align='center' width='1'><a href='viewuserdetail.php?key=<?php echo $user; ?>'><img width='25' height='23' src='image/aaa.png' title='View Detail'></img></a></td>

									<td><a href='edituser.php?key=<?php echo $user; ?>'><img src='image/edit.jpg' width='32' height='30' title='Edit'></img></a></td>
