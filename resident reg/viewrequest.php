...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		if ($count > 0) {
			echo "<font color='white'> <h4 align='left' style='width:540px;height:50px;background:brown;'>  Dear <font color='white'>" . $ful . " </font> you have (" . $count . ") request for Id card prepartion click the  sender name to see the detail of the request.</h4></font>";
			echo "<table id='vtable' style='width:300px;border:0px solid #eee;' align='center' valign='top' align='left'><font color=white>
";
			$i = 1;
			while ($row = mysqli_fetch_array($result)) {
				...
				$id = $row['id'];
				echo "<tr>
<th bgcolor='#eee'><font color='Black' size='3'> Requst " . $i . " send from: </th>
</tr>";
				echo "<tr>";
				print("<td align = 'center' width = '1' color='red'><a href = 'viewrequestdetail.php?key1=" . $ctrl . "&id=" . $id . "' title='Click here to see the dtail'>$ctrl</a></td>");
			...
			echo "<h4 style='width:540px;height:40px;background:brown;' align='left'><font color='white'><font color='grean' size='5'>(!)</font> You have no new request for Id card preparation.<font></h4>";
		mysqli_close($conn);
		?>
