...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		<font color='white'>
			<h4 align="left" style="width: 550px;height: 53px;background: brown">
				<font color="grean " size='5'>(?)</font> Welcome &nbsp;<font color=''><?php echo $ful; ?></font>&nbsp; please select the date to generate population registration report daily,weekly,monthly and yearly.
			</h4>
		</font>

		<a href="popureport.php">Daily Register population</a><br><br>&nbsp;&nbsp;&nbsp;<a href="weeklypop.php">Weekly Register population</a><br><br>&nbsp;&nbsp;&nbsp;<a href="monthlypop.php">Monthly Register population</a><br><br>&nbsp;&nbsp;&nbsp;<a href="yearpop.php">Yearly Register population</a>
