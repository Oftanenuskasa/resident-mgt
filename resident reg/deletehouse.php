...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		include('config.php');
		$ctrl = $_REQUEST['key1'];
		$result = mysqli_query($conn,"delete from house where  HouseNumber = '$ctrl'");
		if ($result) {

			echo "<h4 align='center' style='width:530px;height:30px;background:green'><font color='white'>The data is seccesfully deleted</font></h4>";
		}
		?>
		</td>
		<a href="viewhouse.php"><img src="image/b.png" title="Click here to back to viewpop page.For serch agin."></a>
