		...
		<tr>
			<td width="252" height='300'>
				<table border="0" bgcolor="#CCCCCC" cellspacing="0" valign="top">
					<tr>
						<td width="270" height="550" valign="top">
...
";
	...
	<th width="1047" height="300" valign="top" bgcolor="white"><br>
		...
		$res = "SELECT `id`, `FirstName`, `middleName`, `LastName` FROM `population` WHERE id='$id'";
		...
		<fieldset>
			...
			<br>
			<div>
				<form onsubmit='return formValidator()' action='account.php' method='POST'>
					<table width="100%" height="250px" cellpadding="3" align="center">
						<tr>
							<td align="left"><em>Id :</em></td>
							<td><input type="text" size="20px" id='id' name='id' readonly="" placeholder="Enter user id..." value="<?php echo $id; ?>" style="width: 200;height: 30; background:#eee;"></td>
						</tr>
						<tr>
							<td align="left"> <em>First Name :</em></td>
							<td><input type="text" size="20px" id='name' readonly="" name='fname' placeholder="Enter first name..." value="<?php echo $first; ?>" style="width: 200;height: 30; background:#eee;"></td>
						</tr>
						<tr>
						<tr>
							<td align="left"> <em>Middle Name :</em></td>
							<td><input type="text" size="20px" id='name' name='mname' readonly="" value="<?php echo $midd; ?>" placeholder="Enter middle name..." style="width: 200;height: 30; background:#eee;"></td>
						</tr>
						<tr>
						<tr>
							<td align="left"> <em>Last Name :</em></td>
							<td><input type="text" size="20px" id='name' name='lname' placeholder="Enter last name..." readonly="" value="<?php echo $last; ?>" style="width: 200;height: 30; background:#eee;"></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" size="20px" id='username' name='username' readonly value="<?php echo $first . "." . $midd; ?>" style="width: 200;height: 30; background:#eee;"></td>
						</tr>
						...
						<tr>
							<td></td>
							<td><input type='submit' value='Approve' name='account' height="10px" width="40" onClick="return check(this.form);" style="width: 80;height: 30; background:green;" />
						</tr>
					</table>
				</form>
			</div>
		...
		if (isset($_POST['account'])) {
			...
			$pass = 'resident';
			$p = md5($pass);
			$sql = "INSERT INTO `user`(`id`, `frist_name`, `mname`, `lname`, `Position`, `Username`, `Password`, `status`) VALUES
    ('$_POST[id]','$_POST[fname]','$_POST[mname]','$_POST[lname]','$_POST[position]','$_POST[username]','" . $p . "','1')";
			if (!mysqli_query($conn, $sql)) {
				die('Error: ' . mysqli_error($conn));
			} else {
				$delet = "UPDATE `registernoti` SET `seen`=1 WHERE id='$id1'";
				if (mysqli_query($conn, $delet)) {
					echo "<h4 align='center' style='width:400px;height:35px;background:brown'><font color='white'>The account is created !!</font></h4>";
				}
			}
			mysqli_close($conn);
		}
	...
	<tr>
		<td colspan="3" height="25">
			<table border="0" align="left" width="92%" bgcolor="#CCCCCC" cellspacing="0">
				<tr>
					<td align="='center'">
						<font face="Times New Roman" color="black"><b> DURAME CITY RESIDENCE RECORD MANAGMENT SYSTEM
								&copy; 2024 COPY RIGHT RESERVED !!!</b>
						</font>
					</td>
				</tr>
			</table>
