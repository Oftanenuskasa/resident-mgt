...
";
	...
	<th width="1047" height="436" valign="top" bgcolor="white"><br>
		...
		<table id="contentbox" border="1" width="100%">
				...
				<td>
					...
					<div id="print_content">
						...
						<div align="center" style="margin-top:10px;"><strong><img src="image/r.jpg" width="100%" height="80" align="center">
								<p align="center"><strong>Weekly Population or Resident Registration Report </strong>
								<p> from <?php echo date('Y-m-d', strtotime($date . '- 1 weeks'));  ?>-to-<?php echo date('Y-m-d'); ?></p>
						</div>
						</p>
						<?php
			...
			<tr>
				<td colspan="7" bgcolor="#eee">General population registration report in one week.</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="5">Total number of resident registered in one week</td>
